...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru21-binaries/releases/download/${tag_name}/${asset_name}"
...
download_github_releases 'ibmruntimes' 'semeru21-binaries' "${RELEASE_FILE}"
