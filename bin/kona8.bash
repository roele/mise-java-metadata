...
function download {
	...
	local url="https://github.com/Tencent/TencentKona-8/releases/download/${tag_name}/${asset_name}"
	...
	then
		...
		then
			...
			regex='s/^TencentKona-([0-9.]{1,}-[0-9]+)\.x86_64\.tar\.gz$/VERSION="$1" JAVA_VERSION="8u$2"/g'
			OS="linux"
			ARCH="x86_64"
			EXT="tar.gz"
		else
...
download_github_releases 'Tencent' 'TencentKona-8' "${RELEASE_FILE}"
