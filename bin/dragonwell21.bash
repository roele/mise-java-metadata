...
function download {
	...
	local url="https://github.com/dragonwell-project/dragonwell21/releases/download/${tag_name}/${asset_name}"
...
download_github_releases 'dragonwell-project' 'dragonwell21' "${RELEASE_FILE}"
