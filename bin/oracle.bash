...
download_file 'https://www.oracle.com/java/technologies/javase/jdk17-archive-downloads.html' "${INDEX_FILE}"
...
do
	...
	JDK_URL="https://download.oracle.com/java/17/archive/${JDK_FILE}"
	if [[ -f "${METADATA_FILE}" ]]
	then
