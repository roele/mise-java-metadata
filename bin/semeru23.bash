...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru23-binaries/releases/download/${tag_name}/${asset_name}"
...
RELEASE_FILE="${TEMP_DIR}/releases-${VENDOR}-23.json"
download_github_releases 'ibmruntimes' 'semeru23-binaries' "${RELEASE_FILE}"
