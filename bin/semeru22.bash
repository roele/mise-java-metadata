...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru22-binaries/releases/download/${tag_name}/${asset_name}"
...
RELEASE_FILE="${TEMP_DIR}/releases-${VENDOR}-22.json"
download_github_releases 'ibmruntimes' 'semeru22-binaries' "${RELEASE_FILE}"
