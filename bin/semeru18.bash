...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru18-binaries/releases/download/${tag_name}/${asset_name}"
...
RELEASE_FILE="${TEMP_DIR}/releases-${VENDOR}-18.json"
download_github_releases 'ibmruntimes' 'semeru18-binaries' "${RELEASE_FILE}"
