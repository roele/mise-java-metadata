...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru20-binaries/releases/download/${tag_name}/${asset_name}"
...
RELEASE_FILE="${TEMP_DIR}/releases-${VENDOR}-20.json"
download_github_releases 'ibmruntimes' 'semeru20-binaries' "${RELEASE_FILE}"
